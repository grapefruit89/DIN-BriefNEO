...
url = "https://chromestatus.com/api/v0/features?q=shipping_year:2025&num=500"
headers = {
...
print(f"total_count (2025): {total_count}")
print(f"Anzahl initial erhaltener Features: {len(features)}")

if len(features) < total_count:
    print("Pagination aktiv, lade restliche Features...")
    start = len(features)
    while len(features) < total_count:
        p_url = f"https://chromestatus.com/api/v0/features?q=shipping_year:2025&num=100&start={start}"
...
# JSON speichern
json_path = r"C:\Users\morit\Documents\dinbrief-temp\research_results\chrome_features_2025.json"
...
txt_path = r"C:\Users\morit\Documents\dinbrief-temp\research_results\chrome_features_2025_overview.txt"
with open(txt_path, "w", encoding="utf-8") as f:
    f.write("=" * 80 + "\n")
    f.write(f"CHROME FEATURES 2025 (shipping_year:2025) - GESAMT: {len(features)}\n")
    f.write("=" * 80 + "\n\n")
