/* OPTIMIERUNG JS-KILLER: JS wird komplett von Positionierungs-Aufgaben befreit! Das Dropdown hängt per CSS position-anchor am Input-Feld, die Breite wird via width: anchor-size(width) berechnet. */
// @ts-check
