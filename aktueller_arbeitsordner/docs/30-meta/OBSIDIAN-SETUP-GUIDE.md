...
3. **Wikilinks aktivieren:** Unter *Settings → Files & Links → Use `[[Wikilinks]]`* einschalten — **unbedingt vor dem ersten Schreiben von Links**, sonst fügt Obsidian Standard-Markdown-Links `[titel](pfad.md)` ein.
