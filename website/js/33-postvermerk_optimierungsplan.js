/* OPTIMIERUNG JS-KILLER: JS-Logik für Fake-Selects (Focus-Traps, Key-Handling, Dropdown-Animation) stirbt restlos. Ersatz: Natives <select> mit CSS ::picker() und ppearance: base-select. */
// @ts-check
