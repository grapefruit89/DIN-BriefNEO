...
# 10 — Anforderung: DOM-First Integrity

## 1. Domain-Spec
Etablierung des DOM als primäre SSoT (Single Source of Truth) während der Runtime. Elimination von synchronem JS-State-Overhead beim Tippen. Kontextsensitive UI-Ausrichtung via physikalischer Anker.
...
- **Source:** Das DOM liefert die Daten für den `StateManager`.
...
- **Constraint:** Schutz von DIN-Labels (z.B. "Ihr Zeichen") vor Löschung durch den Nutzer.
